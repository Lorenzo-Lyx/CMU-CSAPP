...
#---------------------------2022-7-24--------------------------------#
#@modify: the iaddq is a valid instruction.
...
#---------------------------2022-7-24--------------------------------#
#@modify: the iaddq need register.
#bool need_regids =
...
#---------------------------2022-7-24--------------------------------#
#@modify: the iaddq need a constent.
#bool need_valC =
...
#---------------------------2022-7-24--------------------------------#
#@modify: iaddq need the B source.
word d_srcB = [
...
#---------------------------2022-7-24--------------------------------#
#@modify: iaddq need the E destination.
word d_dstE = [
...
#---------------------------2022-7-24--------------------------------#
#@modify: the iaddq's aluA is valC, the aluB is valB.
word aluA = [
...
#---------------------------2022-7-24--------------------------------#
#@modify: iaddq instruction needs set condition regsiters.
